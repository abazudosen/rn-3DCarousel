...
const Content = ({ item }) => {
  return (
    <>
      ...
      <Text style={{ fontSize: 13, opacity: 0.6, color: "black" }}>{item.subtitle}</Text>
...
export default () => {
  ...
  return (
    <View style={{ backgroundColor: "#5F4B8BFF", flex: 1 }}>
      <StatusBar hidden />
        ...
        >
          ...
          >
            <View style={{ flexDirection: "row", alignItems: "center" }}>
              <AntDesign name="swapleft" size={42} color="white" />
              <Text style={{ fontSize: 14, fontWeight: "900", color: "white", }}>PREV</Text>
            </View>
          </TouchableOpacity>
          <TouchableOpacity
          ...
          >
            <View style={{ flexDirection: "row", alignItems: "center" }}>
              <Text style={{ fontSize: 14, fontWeight: "900", color: "white", }}>NEXT</Text>
              <AntDesign name="swapright" size={42} color="white" />
            </View>
          </TouchableOpacity> 
        </View>
      </SafeAreaView> 
